...
# NexTerm — Lightweight SSH Client for macOS, Windows & Linux
...
<div align="center">
  <img src="screenshots/app-screenshot.png" alt="NexTerm Application Screenshot" width="100%">
  <p><i>NexTerm — split terminals, file manager, and system monitor in a single window</i></p>
</div>
...
Most SSH clients (FinalShell, MobaXterm, Xshell) run on Java or Electron — burning memory even at idle. NexTerm uses Rust + Tauri 2 for native performance at a fraction of the cost.
...
|-----|-----------|--------|----------|
| **NexTerm** | Rust + Tauri 2 | **~34 MB** | **1×** |
| FinalShell | Java | **~1.7 GB** | **~50×** |

### Installer Size

| Platform | NexTerm | FinalShell | Savings |
|----------|---------|-----------|----------|
...
NexTerm combines an interactive terminal, dual-panel file manager, remote desktop viewer (RDP/VNC), real-time system/GPU monitoring, and log viewing in a single VS Code-like workspace. Built with Rust for native performance and minimal resource usage.
...
| Platform | File |
|----------|------|
| macOS (Apple Silicon) | `nexterm_x.x.x_aarch64.dmg` |
| macOS (Intel) | `nexterm_x.x.x_x64.dmg` |
| Windows | `nexterm_x.x.x_x64-setup.exe` |
| Linux | `nexterm_x.x.x_amd64.AppImage` / `.deb` |
