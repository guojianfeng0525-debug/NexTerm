...
import type { PostgresConnection } from '../toolbox/toolbox-types';
...
const profile: PostgresConnection = {
  id: 'pg-1', name: 'Production', environment: 'production', host: 'db.example.com', port: 5432,
  database: 'app', username: 'app_user', password: 'database-secret', defaultSchema: 'app',
  ...
  sshHostKeyFingerprint: 'SHA256:trusted', createdAt: 1, updatedAt: 1,
};
