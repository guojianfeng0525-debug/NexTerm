...
import { hydrateConnectionsStorage } from "../lib/connection-storage";
...
// In-memory SQLite stand-in for the storage hydration.
...
describe("ConnectionManager folder selection", () => {
  ...
  beforeEach(async () => {
    ...
    // Seed the SQLite stand-in with folders + one connection.
    seedRow(ipc, "folders", {
      id: folderWorkId,
      name: "Work",
      path: "Work",
    ...
    // Hydrate the in-memory cache from the stand-in.
