...
export function WelcomeScreen({ onNewConnection, onOpenSettings, onOpenToolbox }: WelcomeScreenProps) {
  ...
  const quickActions = [
    ...
    {
      icon: Wrench,
      title: t('welcome.toolbox'),
      description: t('welcome.toolboxDesc'),
      action: onOpenToolbox ?? (() => {}),
      variant: 'outline' as const,
      highlight: t('welcome.toolboxHighlight')
    },
    {
      icon: Settings,
