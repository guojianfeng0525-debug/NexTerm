...
export function ToolSqlite() {
  ...
  return <DatabaseWorkspaceShell
    ...
    tabClassName={() => "flex h-8 min-w-28 items-center gap-1 border-r px-2 text-[12px]"}
