...
**DB 工具箱三库（PostgreSQL / MySQL / SQLite）UX 对齐增强**。
...
- tsc 0 错误 / vitest 992（107 文件）全绿 / lint 无新增 error（1 为 main 基线存量）/ 生产构建通过
- GATE 视觉门禁 25 项运行时断言 PASS；e2e 集成套件 `db-toolbox-ux.e2e.spec.ts` 4 passed / 1 skipped（预期）
